  ...
  const loadDemoData = () => {
    ...
    const demoData: Attempt[] = [
      ...
      },
      {
        ...
        mood: 'tense',
        notes: '一面刚结束，正在复习浏览器渲染原理和网络协议，准备迎接二面。',
      ...
      },
      {
        ...
        jdText: '负责配送调度算法优化；参与强化学习模型训练；极强的手写算法和数学推导能力。',
        mood: 'tense',
      ...
      },
      {
        ...
        mood: 'calm',
        notes: '流程持续了一周，虽然最后没完成面试，但跟面试官聊还是知道了自己的不足T T',
